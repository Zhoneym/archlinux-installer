...
curl -O https://codeberg.org/Zhoneym/archlinux-installer/raw/branch/main/pacman.conf && mv pacman.conf /etc/pacman.conf
...
install(){
    pacman -Sy
    pacstrap -i /mnt base base-devel net-tools linux-zen linux-zen-headers linux-zen-docs linux-firmware axel
    genfstab -U -p /mnt > /mnt/etc/fstab
}

config(){
    wget https://codeberg.org/Zhoneym/archlinux-installer/raw/branch/main/basicconfig.sh -O /mnt/root/config.sh
    curl -O https://codeberg.org/Zhoneym/archlinux-installer/raw/branch/main/pacman.conf && mv pacman.conf /mnt/etc/pacman.conf
